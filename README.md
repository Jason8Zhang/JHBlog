...
### iOS底层
- [1、一个NSObject对象占用多少内存](./iOS知识点/iOS底层/1、一个NSObject对象占用多少内存.md)
- [2、OC对象的分类](./iOS知识点/iOS底层/2、OC对象的分类.md)
- [3、KVO实现原理](./iOS知识点/iOS底层/3、KVO.md)
- [4、KVC实现原理](./iOS知识点/iOS底层/4、KVC.md)
- [5、分类](./iOS知识点/iOS底层/分类/1、分类的实现原理.md)
    - [5.1、分类的实现原理](./iOS知识点/iOS底层/分类/1、分类的实现原理.md)
    - [5.2、Load和Initialize实现原理](./iOS知识点/iOS底层/分类/2、Load和Initialize实现原理.md)
- [6、Block底层解密](.iOS知识点/iOS底层/7、Block底层解密.md)
 - [7、RunLoop实现原理](./iOS知识点/iOS底层/8、RunLoop.md)
 - [8、RunTime实现原理](./iOS知识点/iOS底层/RunTime/0、运行时.md)
    - [8.1、isa解析](./iOS知识点/iOS底层/RunTime/1、isa.md)
    - [8.2、方法缓存](./iOS知识点/iOS底层/RunTime/2、方法缓存.md)
    - [8.3、objc_msgSend执行流程](./iOS知识点/iOS底层/RunTime/3、objc_msgSend执行流程.md)
    - [8.4、@dynamic关键字](./iOS知识点/iOS底层/RunTime/4、@dynamic关键字.md)
    - [8.5、Class和SuperClass区别](./iOS知识点/iOS底层/RunTime/5、Class%26SuperClass.md)
    - [8.6、isKindOfClass和isMemberOfClass区别 ](./iOS知识点/iOS底层/RunTime/6、isMemberOfClass%26.isKindOfClassmd.md)
    - [8.7、RunTime的相关API](./master/iOS知识点/iOS底层/RunTime/7、API.md)
- [9、多线程](1、多线程面试题)
    - [9.1、多线程面试题](./master/iOS知识点/iOS底层/多线程/1、多线程面试题.md)
    - [9.2、多线程之NSThread](./iOS知识点/iOS底层/多线程/2、NSThread介绍.md)
    - [9.3、多线程之GCD](./iOS知识点/iOS底层/多线程/3、GCD介绍.md)
    - [9.4、多线程之NSOperation](./iOS知识点/iOS底层/多线程/4、NSOperation介绍.md)
    - [9.5、多线程之线程安全](./iOS知识点/iOS底层/多线程/5、线程安全.md)
    - [9.6、死锁](./iOS知识点/iOS底层/多线程/6、死锁.md)
    - [9.7、线程之间的通讯](./iOS知识点/iOS底层/多线程/8、线程之间的通讯.md)
    - [9.8、GCD高级用法](./iOS知识点/iOS底层/多线程/7、GCD高级用法.md)
    - [9.9、深入浅出 iOS 并发编程](https://www.jianshu.com/p/39d6edb54d24)
- [10、内存管理]()  
    - [10.1、定时器target的内存泄漏](./iOS知识点/iOS底层/内存管理/1、定时器.md)
    - [10.2、Tagged Pointer](./iOS知识点/iOS底层/内存管理/2、tagged%20pointer.md)
    - [10.3、copy&retain&strong原理](./iOS知识点/iOS底层/内存管理/3、copy%26retain%26strong原理.md)
    - [10.4、weak&assign原理](./iOS知识点/iOS底层/内存管理/4、weak%26assign原理.md)
    - [10.5、@property 的本质是什么](./iOS知识点/iOS底层/内存管理/5、%40property%20的本质是什么.md)
    - [10.6、autorelease原理](./iOS知识点/iOS底层/内存管理/6、autorelease原理.md)
    - [10.7、atomic 一定是线程安全的吗](./iOS知识点/iOS底层/内存管理/7、atomic%20一定是线程安全的吗.md)
    - [10.8、dealloc原理](./iOS知识点/iOS底层/内存管理/8、dealoc原理.md)
    - [10.9、引用计数的存储](./master/iOS知识点/iOS底层/内存管理/9、引用计数的存储.md)
...
- 1、[LLDB使用](./iOS知识点/iOS大杂烩/LLDB/LLDB.md)
    - [如何快速列出App的所有+load方法](./iOS知识点/iOS大杂烩/LLDB/如何快速列出App的所有%2Bload方法/如何快速列出App的所有%2Bload方法.md)
- 2、[基本数据类型](./iOS知识点/iOS大杂烩/打印各种数据类型.md)
- 3、[App信息监控](./iOS知识点/iOS大杂烩/App需要监控信息.md)
- 4、[Crash系列]()
    - [1、Crash产生原因](./iOS知识点/iOS大杂烩/Crash收集/1、Crash产生原因.md)
    - [2、Crash日志收集](./iOS知识点/iOS大杂烩/Crash收集/2、Crash日志收集.md)
    - [3、Crash日志分析](./iOS知识点/iOS大杂烩/Crash收集/3、Crash日志分析.md)
    - [4、NSException抛出异常](./iOS知识点/iOS大杂烩/Crash收集/4、NSException抛出异常.md)
    - [5、符号表&dSYM](./iOS知识点/iOS大杂烩/Crash收集/5、符号表.md)
- 5、[armv7,armv7s,arm64,i386,x86_64 简单了解](./iOS大杂烩/armv7%2Carmv7s%2Carm64%2Ci386%2Cx86_64.md)
- 6、[performSelector的原理以及用法](./iOS大杂烩/performSelector的原理以及用法.md)
- 7、[更新cocoapod](./iOS大杂烩/更新cocoapod.md)
- 8、[为什么不能在子线程中刷新UI](./iOS知识点/iOS大杂烩/为什么不能在子线程中刷新UI.md)
- 9、[UIViewController](https://github.com/SunshineBrother/JHBlog/tree/master/iOS知识点/iOS大杂烩/UIViewController)
    - 1、[UIViewController的生命周期](./iOS大杂烩/UIViewController/UIViewController的生命周期.md)
    - 2、[UIViewController重构](./iOS大杂烩/UIViewController/UIViewController重构.md)
    - 3、[layoutSubviews总结](./iOS大杂烩/UIViewController/layoutSubviews总结.md)
- 10、[ios真机调试包路径及配置文件路径](./iOS大杂烩/ios真机调试包路径及配置文件路径.md)
- 11、[Cocoa框架Foundation和UIKit的区别](./iOS大杂烩/Cocoa框架Foundation和UIKit的区别/Cocoa框架Foundation和UIKit的区别.md)
- 12、[UIView和CALayer的区别](./iOS大杂烩/UIView和CALayer的区别？.md)
- 13、[frame和bounds的区别](./iOS大杂烩/frame和bounds的区别/frame和bounds的区别.md)
- 14、[浅谈性能优化](./iOS大杂烩/简单性能优化/性能优化.md)
- 15、[UITableView架构总结](./iOS大杂烩/对UITableView进行性能调优/UITableView架构总结.md)
- 16、[加载大图的优化算法](./iOS大杂烩/加载大图的优化算法/加载大图的优化算法.md)
- 17、[App启动时间优化](./iOS大杂烩/APP启动优化/App启动时间优化.md)
- 18、[drawRect为什么导致CPU飙升](./iOS大杂烩/动画/drawRect/drawRect为什么导致CPU飙升.md)
- 19、[页面间跳转的性能优化](./iOS大杂烩/页面间跳转的性能优化/页面间跳转的性能优化.md)
- 20、[常见耗电量检测方案调研](./iOS大杂烩/常见耗电量检测方案调研.md)
- 21、[5种常见的消息传递机制以及他们之间区别](./iOS大杂烩/5种常见的消息传递机制以及他们之间区别/5种常见的消息传递机制以及他们之间区别.md)
- 22、[写一个好的单例](https://github.com/SunshineBrother/JHBlog/blob/master/设计模式/设计模式/单例模式/单例模式.md)
- 23、[事件响应机制](./iOS大杂烩/事件响应机制/事件响应机制.md)
- 24、[iOS 单元测试和 UI 测试快速入门](https://github.com/xietao3/Study-Plan/blob/master/TestingTutorial/README.md)
- 25、[配置.gitignore忽略文件](./iOS大杂烩/忽略文件/iOS%20配置.gitignore忽略文件.md)
- 26、[git使用](./iOS大杂烩/git使用/git使用.md)
- 27、[iOS内购](./iOS大杂烩/iOS内购.md)
- 28、[NSArray原理及遍历方法探究](./iOS大杂烩/NSArray原理及遍历方法探究.md)
- 30、[UIResponder](./iOS大杂烩/事件响应机制/事件响应机制.md)
- 31、[UIControl](./iOS大杂烩/UIControl/UIControl.md)
- 32、[什么是离屏渲染](./iOS大杂烩/什么是离屏渲染/什么是离屏渲染.md)
